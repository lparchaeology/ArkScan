...
class Ui_ArkScanMainWindow(object):
    def setupUi(self, ArkScanMainWindow):
        ...
        self.m_numberLabel = QtGui.QLabel(self.widget)
        ...
        self.m_defaultScanAreaButton = QtGui.QPushButton(self.widget)
        ...
        self.m_scanSizeLabel1 = QtGui.QLabel(self.widget)
        ...
        self.m_scanSizeLabel2 = QtGui.QLabel(self.widget)
        ...
        self.m_detectCropAreaButton = QtGui.QPushButton(self.widget)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1089, 33))
