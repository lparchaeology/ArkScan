...
class Ui_ArkScanMainWindow(object):
    def setupUi(self, ArkScanMainWindow):
        ...
        self.gridLayout_2.addLayout(self.m_scanSizeLayout, 5, 0, 1, 2)
        ...
        self.m_pageSizeCombo.addItem(_fromUtf8(""))
        self.m_pageSizeCombo.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.m_pageSizeCombo, 3, 1, 1, 1)
        self.m_pageSizeLabel = QtGui.QLabel(self.groupBox)
        self.m_pageSizeLabel.setObjectName(_fromUtf8("m_pageSizeLabel"))
        self.gridLayout_2.addWidget(self.m_pageSizeLabel, 3, 0, 1, 1)
        ...
        self.m_savePlanButton = QtGui.QPushButton(self.groupBox1)
        self.m_savePlanButton.setObjectName(_fromUtf8("m_savePlanButton"))
        self.horizontalLayout_3.addWidget(self.m_savePlanButton)
        ...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.m_detectCropAreaAction)
        self.toolBar.addAction(self.m_cropAction)

        self.retranslateUi(ArkScanMainWindow)
        QtCore.QObject.connect(self.m_scanSavePlanButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.m_scanSavePlanAction.trigger)
        QtCore.QObject.connect(self.m_savePlanButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.m_savePlanAction.trigger)
        ...
        ArkScanMainWindow.setTabOrder(self.m_pageSizeCombo, self.m_xOriginSpin)
    ...
    def retranslateUi(self, ArkScanMainWindow):
        ...
        self.m_savePlanButton.setText(_translate("ArkScanMainWindow", "Save", None))
