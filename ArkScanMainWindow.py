...
#
# Created: Fri Jan 30 14:33:10 2015
...
class Ui_ArkScanMainWindow(object):
    def setupUi(self, ArkScanMainWindow):
        ...
        ArkScanMainWindow.resize(1089, 931)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.m_suffixEdit)
        self.m_suffixLabel = QtGui.QLabel(self.layoutWidget)
        self.m_suffixLabel.setObjectName(_fromUtf8("m_suffixLabel"))
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.m_suffixLabel)
        ...
        ArkScanMainWindow.setTabOrder(self.m_numberSpin, self.m_suffixEdit)
        ArkScanMainWindow.setTabOrder(self.m_suffixEdit, self.m_eastSpin)
    ...
    def retranslateUi(self, ArkScanMainWindow):
        ...
        self.m_typeCombo.setItemText(3, _translate("ArkScanMainWindow", "Matrix", None))
        ...
        self.m_defaultScanAreaButton.setText(_translate("ArkScanMainWindow", "Default Scan Area", None))
